...
public class ComplaintDAOImpl implements ComplaintDAO {
    ...
    private final static String GET_ALL_BY_CSR_ID = "SELECT * FROM COMPLAINTS WHERE CSR_ID=:csr_id";
    private final static String GET_ALL_BY_ORDER_ID = "SELECT * FROM COMPLAINTS WHERE ORDER_ID=:order_id";
    ...
    public List<Complaint> getByCSRId(int id) {
        ...
        return jdbcTemplate.query(GET_ALL_BY_CSR_ID, params,complaintRowMapper);
    }
    ...
    public List<Complaint> getByOrderId(int id) {
        ...
        return jdbcTemplate.query(GET_ALL_BY_ORDER_ID, params,complaintRowMapper);
    }
