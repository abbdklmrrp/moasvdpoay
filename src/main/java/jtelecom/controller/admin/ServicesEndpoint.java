...
public class ServicesEndpoint { // GET: admin/category/1
    ...
    public List<ServicesByCategoryDto> servicesByTariff(@PathVariable("categoryId") Integer categoryId) {
//        Map<String, List<Product>> allServicesWithCategory = productDao.getAllServicesWithCategory();
        ...
        List<ServicesByCategoryDto> servicesByCategoryDtoList = productDao.findServicesByCategoryId(categoryId);
        logger.debug("Create service dto {} ", servicesByCategoryDtoList.toString());
