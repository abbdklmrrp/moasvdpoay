            ...
            "aoColumns": [
                ...
                { "mData": "duration"},
                {
                    ...
                    "mRender": function(data) {
                        return '<a class="btn btn-info btn-sm" href=${contextPath}/csr/getDetails?id='+data+'>' +"Connect"+'</a>',
                        '<a class="btn btn-info btn-sm" href=${contextPath}/csr/getDetails?id='+data+'>' +"Deactive"+'</a>' ;
                    }}
            ],
            "paging":true
        });
