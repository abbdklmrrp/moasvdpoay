        ...
        renderers: {
            "action": function (pv, wv, grid) {
                if (wv.operation_status == "Suspended") {
                    return $('<div id=order' + wv.order_id + '><input type="button" class="btn btn-success btn-block"  style="margin:5px 5px 5px 5px" value="Resume" onclick="activateOrderAfterSuspend(' + wv.order_id + ')">' +
