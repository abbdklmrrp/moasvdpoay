        ...
        <div class="col-md-7 col-sm-10 col-xs-10">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-5">
                    <select id="products" name="products" class="form-control" aria-required="true" style="float: right">
            ...
            <br>
            <textarea id="description" name="description" cols="60" rows="15"></textarea>
            <br>
            <br>
            <div class="row">
