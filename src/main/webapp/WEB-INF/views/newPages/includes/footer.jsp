...
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap/jquery.prettyPhoto.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap/main.js"/>"></script>
