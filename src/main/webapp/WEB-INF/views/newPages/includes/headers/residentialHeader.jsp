            ...
            <ul class="nav navbar-nav ">
                <c:choose>
                    <c:when test="${param.pageName == 'Profile'}">
                        <li class="active"><a href="<%=request.getContextPath()%>/residential/getProfile">Profile</a></li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${param.pageName == 'Orders'}">
                        <li class="active"><a href="<%=request.getContextPath()%>/residential/orders">Orders</a></li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${param.pageName == 'Tariffs'}">
                        <li class="active"><a href="<%=request.getContextPath()%>/residential/tariffs">Tariffs</a></li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${param.pageName == 'Services'}">
                        <li class="active"><a href="<%=request.getContextPath()%>/residential/orderService">Services</a>
                        </li>
                    </c:when>
                    <c:otherwise>
